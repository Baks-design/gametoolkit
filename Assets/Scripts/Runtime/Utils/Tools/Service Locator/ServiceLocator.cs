...
namespace GameToolkit.Runtime.Utils.Tools.ServicesLocator
{
    ...
    public class ServiceLocator : MonoBehaviour
    {
        ...
        public static ServiceLocator ForSceneOf(MonoBehaviour mb)
        {
            ...
            {
                tmpSceneGameObjects[i].TryGetComponent<ServiceLocatorScene>(out var bootstrapper);
                if (bootstrapper != null && bootstrapper.Container != mb)
                {
        ...
        {
            var parentLocator = mb.GetComponentInParent<ServiceLocator>();
        ...
        public ServiceLocator Get<T>(out T service)
            where T : class
        {
        ...
        bool TryGetService<T>(out T service)
            where T : class => services.TryGet(out service);
        ...
        bool TryGetNextInHierarchy(out ServiceLocator container)
        {
            ...
            {
                var parentLocator = transform.parent.GetComponentInParent<ServiceLocator>();
                if (parentLocator != null)
                {
        ...
        static void AddGlobal() =>
            new GameObject(k_globalServiceLocatorName, typeof(ServiceLocatorGlobal));

        [MenuItem("GameObject/ServiceLocator/Add Scene")]
        static void AddScene() =>
            new GameObject(k_sceneServiceLocatorName, typeof(ServiceLocatorScene));
#endif
    }
}
