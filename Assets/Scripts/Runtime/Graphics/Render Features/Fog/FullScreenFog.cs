...
namespace GameToolkit.Runtime.Graphics.RenderFeatures.Fog
{
    /// <summary>
    /// Fog mode
    /// </summary>
    ...
    public sealed class FullScreenFogModeParameter : VolumeParameter<FullScreenFogMode>
    {
        ...
        public FullScreenFogModeParameter(FullScreenFogMode value, bool overrideState = false)
    ...
    /// </summary>
    [Serializable]
    public sealed class FullScreenFogDensityModeParameter
        : VolumeParameter<FullScreenFogDensityMode>
    {
        /// <summary>
        ...
        /// <param name="value">The initial value to store in the parameter.</param>
        /// <param name="overrideState">The initial override state for the parameter.</param>
        public FullScreenFogDensityModeParameter(
            FullScreenFogDensityMode value,
    ...
    public sealed class FullScreenFogNoiseModeParameter : VolumeParameter<FullScreenFogNoiseMode>
    {
        ...
        /// <param name="value">The initial value to store in the parameter.</param>
        /// <param name="overrideState">The initial override state for the parameter.</param>
        public FullScreenFogNoiseModeParameter(
            FullScreenFogNoiseMode value,
            bool overrideState = false
        )
            : base(value, overrideState) { }
    }
    ...
    /// </summary>
    [Serializable, VolumeComponentMenu("/Full Screen Fog")]
    ...
    public class FullScreenFog : VolumeComponent, IPostProcessComponent
    {
        ...
        public FullScreenFogDensityModeParameter densityMode =
            new(FullScreenFogDensityMode.ExponentialSquared);
        ...
        internal static bool UseStartLine(FullScreenFogMode mode) =>
            mode == FullScreenFogMode.Depth || mode == FullScreenFogMode.Distance;
        ...
        internal static bool UseEndLine(
            FullScreenFogMode mode,
            FullScreenFogDensityMode densityMode
        ...
        internal static bool UseStartHeight(FullScreenFogMode mode) =>
            mode == FullScreenFogMode.Height;
        ...
        internal static bool UseEndHeight(
            FullScreenFogMode mode,
            FullScreenFogDensityMode densityMode
        ...
        internal static bool UseIntensity(FullScreenFogDensityMode mode) =>
            mode == FullScreenFogDensityMode.Exponential
            || mode == FullScreenFogDensityMode.ExponentialSquared;
        ...
        internal static bool UseNoiseTex(FullScreenFogNoiseMode noiseMode) =>
            noiseMode == FullScreenFogNoiseMode.Texture;
        ...
        internal static bool UseNoiseIntensity(FullScreenFogNoiseMode noiseMode) =>
            noiseMode != FullScreenFogNoiseMode.Off;
